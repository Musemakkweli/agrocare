      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-green-600">
          <div className="flex items-center gap-2">
            ...
            {!isCollapsed && <span className="font-bold text-lg">Finance</span>}
          </div>
        ...
        <div className="flex items-center gap-3 p-6">
          ...
          {!isCollapsed && (
            <div>
              <p className="font-semibold">{user?.name || "Finance"}</p>
              <p className="text-xs">Finance Manager</p>
            </div>
          )}
        </div>
        ...
        <nav className="px-3 space-y-1">
          ...
          <button
            onClick={() => navigate("/finance/manage-funds")}
            className={sidebarBtn("/finance/manage-funds")}
          >
            <FontAwesomeIcon icon={faDollarSign} />
            {!isCollapsed && "Manage Funds"}
          </button>

          <button
            onClick={() => navigate("/profile")}
            className={sidebarBtn("/finance/profile")}
          >
